...
<option>SELECT * FROM Jiaguwen WHERE descr LIKE '2hands' ORDER BY jink; 2hands</option>
<option>SELECT * FROM Jiaguwen WHERE jink LIKE '%58515%' ORDER BY jink; hand</option>
<option>SELECT * FROM Jiaguwen WHERE jink LIKE '%57344%' ORDER BY jink; man,woman:57869,slave:57720, king:57571,son:62629,father:58525</option>
<option>SELECT * FROM Jiaguwen WHERE jink LIKE '%58283%' ORDER BY jink; manger</option>
<option>SELECT * FROM Jiaguwen WHERE jink LIKE '%62548%' ORDER BY jink; cross</option>
...
<option>SELECT jid, jnm FROM Jiaguwen WHERE jnm LIKE '1%' or  jnm LIKE '2%' or  jnm LIKE '3%' or  jnm LIKE '4%' ORDER BY jnm ASC;;;;; (for d3 logo)</option>
<option>SELECT jid, jnm FROM Jiaguwen WHERE jnm LIKE '5%' ORDER BY jnm ASC;;;;; (for d3 picto)</option>
...
<option>SELECT * FROM bronze0000shang  LIMIT 0,10 ;for UF tdeq2</option>
<option>SELECT * FROM bronze0000shang  LIMIT 0,10 ;for BRF tdeq3</option>
